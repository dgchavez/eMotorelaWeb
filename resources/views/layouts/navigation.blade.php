            ...
            <div class="flex">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                    @if(auth()->user()->isAdmin())
                        ...
                        <x-nav-link :href="route('toda.index')" :active="request()->routeIs('toda.*')">
                            {{ __('TODA Management') }}
                        </x-nav-link>
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
        <div class="pt-2 pb-3 space-y-1">
            @if(auth()->user()->isAdmin())
                ...
                <x-responsive-nav-link :href="route('toda.index')" :active="request()->routeIs('toda.*')">
                    {{ __('TODA Management') }}
                </x-responsive-nav-link>
            ...
            @else
                <!-- Staff Responsive Navigation Links -->
                <x-responsive-nav-link :href="route('dashboard')" :active="request()->routeIs('dashboard')">
                    {{ __('Dashboard') }}
                </x-responsive-nav-link>
        ...
        <div class="pt-4 pb-1 border-t border-gray-200">
            <div class="px-4">
                ...
                <div class="font-medium text-xs text-gray-400">{{ Auth::user()->getRoleName() }}</div>
            </div>
