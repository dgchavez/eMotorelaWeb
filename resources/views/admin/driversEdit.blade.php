                        ...
                        <div class="bg-white rounded-lg shadow p-6">
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                ...
                                <div>
                                    ...
                                    <input type="text" name="middle_name" id="middle_name" value="{{ old('middle_name', $driver->middle_name) }}"
                                        class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500">
                                    @error('middle_name')
                                        <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                                    @enderror
                                ...
                                <div>
                                    ...
                                    <input type="text" name="suffix" id="suffix" value="{{ old('suffix', $driver->suffix) }}"
                                        class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500">
                                    @error('suffix')
                                        <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                                    @enderror
                                ...
                                <div class="md:col-span-2">
                                    ...
                                    <textarea name="address" id="address" rows="3" 
                                        class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500">{{ old('address', $driver->address) }}</textarea>
                                    @error('address')
                                        <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                                    @enderror
                                </div>
                                ...
                                <div>
                                    ...
                                    <input type="text" name="contact_no" id="contact_no" value="{{ old('contact_no', $driver->contact_no) }}"
                                        class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500">
                                    @error('contact_no')
                                        <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                                    @enderror
                        ...
                        <div class="bg-white rounded-lg shadow p-6">
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                <div>
                                    ...
                                    <input type="text" name="drivers_license_no" id="drivers_license_no" value="{{ old('drivers_license_no', $driver->drivers_license_no) }}"
                                        class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500">
                                            ...
                                            @foreach($operators as $operator)
                                                <div class="flex items-center">
                                                    <input type="checkbox" name="operator_ids[]" value="{{ $operator->id }}"
                                                        ...
                                                        {{ in_array($operator->id, old('operator_ids', $driver->operators->pluck('id')->toArray())) ? 'checked' : '' }}
